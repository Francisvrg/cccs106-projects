...
def main(page: ft.Page):
    ...
    content_column = ft.Column(
        [title, ft.Divider(height=8), inputs_column, button_container, ft.Divider(height=6), status_text],
        alignment=ft.MainAxisAlignment.CENTER,
        horizontal_alignment=ft.CrossAxisAlignment.CENTER,
        spacing=8,
    )

    root_container = ft.Container(expand=True, bgcolor=ft.Colors.LIGHT_BLUE_400, content=content_column)
